"""
Nombre: Oriol Jiménez Garrich

Descripción:
Este módulo implementa dos generadores de números pseudoaleatorios usando el método LCG (Linear Congruential Generator).
Ambos, tanto la clase Aleat como la función aleat() permiten generar secuencias de números aleatorios y reiniciar la semilla.
"""
